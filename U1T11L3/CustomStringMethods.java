  ...
  */
  ...
  public String removeCharacter(String myString, int removeIdx) {
    if (removeIdx >= 0 && removeIdx < myString.length()) {
      String before = myString.substring(0, removeIdx);
      String after = myString.substring(removeIdx + 1);
      return before + after;
    } else {
      return myString;
    }
  ...
  */
  public String insertAt(String orig, String insertText, String searchStr) {
    if (orig.indexOf(searchStr) != -1) {
        ...
        String before = orig.substring(0, insertIdx);
        String after = orig.substring(insertIdx);
  ...
  */
  public String endUp(String myString, int numToCap){
    if (numToCap >= myString.length()) {
      ...
      String beginning = myString.substring(0, myString.length() - numToCap);
      String end = myString.substring(myString.length() - numToCap).toUpperCase();
